...
public class QuarterSteppedComplexShape extends AbstractComplexShape implements ComplexShape {
    ...
    public Point draw(double length, double circleModifier, double realCircleAngle, double cTM) {
