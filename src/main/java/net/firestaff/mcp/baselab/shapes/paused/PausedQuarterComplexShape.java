...
public class PausedQuarterComplexShape  extends AbstractComplexShape implements ComplexShape {

    public PausedQuarterComplexShape() {
        name = "PausedQuarterComplexShape";
        PausedQuarterComplexShape.shapeName = name;
        period = Math.PI * 4;
    }
