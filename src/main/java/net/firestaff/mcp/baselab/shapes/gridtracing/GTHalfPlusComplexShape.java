...
public class GTHalfPlusComplexShape  extends AbstractComplexShape implements ComplexShape {

    public GTHalfPlusComplexShape() {
        name = "GTHalfPlusComplexShape";
        GTHalfPlusComplexShape.shapeName = name;
        period = Math.PI * 6.0;
    }
