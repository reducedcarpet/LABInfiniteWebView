...
public class PausedFullCapComplexShape extends AbstractComplexShape implements ComplexShape {

    public PausedFullCapComplexShape() {
        name = "PausedFullComplexShape";
        PausedFullCapComplexShape.shapeName = name;
        period = Math.PI * 3;
    }
