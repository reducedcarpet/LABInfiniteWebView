...
public class PatternsVTG {

    public static List<Pattern> basicTrammelPatterns = new ArrayList<Pattern>();
    private static List<Pattern> basicIsolationPatterns = new ArrayList<Pattern>();
    private static List<Pattern> basicAntispinPatterns = new ArrayList<Pattern>();
    private static List<Pattern> basicHybridPatterns = new ArrayList<Pattern>();
    private static List<Pattern> basicRTypePatterns = new ArrayList<Pattern>();
    ...
    private static List<Pattern> pointHybridPerpPatterns = new ArrayList<Pattern>();
    private static List<Pattern> verticalLinePatterns = new ArrayList<Pattern>();
    private static List<Pattern> superspinPatterns = new ArrayList<Pattern>();
    private static List<Pattern> halfCirclePatterns = new ArrayList<Pattern>();
    ...
    private static List<Pattern> quartertimePatterns = new ArrayList<Pattern>();
    public static List<Pattern> hybridPathTrammelPatterns = new ArrayList<Pattern>();
    private static List<Pattern> extraBeatDiagonalPatterns = new ArrayList<Pattern>();
    private static List<Pattern> boxPatterns = new ArrayList<Pattern>();
    private static List<Pattern> translatedHalfPatterns = new ArrayList<Pattern>();
    private static List<Pattern> translatedQuarterPlusPatterns = new ArrayList<Pattern>();
    ...
    private static List<Pattern> dirChangePatterns = new ArrayList<Pattern>();
    private static List<Pattern> dirChangeVerticalPatterns = new ArrayList<Pattern>();
    private static List<Pattern> pausedCirclePatterns = new ArrayList<Pattern>();
    private static List<Pattern> pausedHalfCirclePatterns = new ArrayList<Pattern>();
    private static List<Pattern> pausedQuartersPatterns = new ArrayList<Pattern>();
    private static List<Pattern> translatedCirclesPatterns = new ArrayList<Pattern>();
    private static List<Pattern> translatedQuarterPatterns = new ArrayList<Pattern>();
    private static List<Pattern> threeQuarterPatterns = new ArrayList<Pattern>();
    private static List<Pattern> threeQuarterHybridPatterns = new ArrayList<Pattern>();
    private static List<Pattern> underArmourHPatterns = new ArrayList<Pattern>();

    private static List<Pattern> FOURSoloQuartersPatterns = new ArrayList<Pattern>();
    private static List<Pattern> FOURUltimateQuartersPatterns = new ArrayList<Pattern>();
    private static List<Pattern> FOURSteppedQuartersPatterns = new ArrayList<Pattern>();
    public static List<Pattern> sluiceGatePatterns = new ArrayList<Pattern>();

    private static List<Pattern> GTPeanutPatterns = new ArrayList<Pattern>();
    private static List<Pattern> GTHalfPlusPatterns = new ArrayList<Pattern>();
    private static List<Pattern> GTPlusKnotPatterns = new ArrayList<Pattern>();
    private static List<Pattern> GTSwitchbackPatterns = new ArrayList<Pattern>();
    private static List<Pattern> GTSwitchbackPlusPatterns = new ArrayList<Pattern>();
    private static List<Pattern> GTThreeBeatKnotPatterns = new ArrayList<Pattern>();
    ...
    private static List<Pattern> superspinTrammelPatterns = new ArrayList<Pattern>();
    ...
    PatternHelperVTG p = new PatternHelperVTG();


    static {
        PatternHelperVTG p = new PatternHelperVTG(); // force patternHelper to init.
        ...
        //PatternGenerator.generateTopHalfCAPSPatterns(verticalCAPSPatterns, CAPSPatterns);
        //PatternGenerator.generateSameSideCAPSPatterns(buzzsawCAPSPatterns, CAPSPatterns);
